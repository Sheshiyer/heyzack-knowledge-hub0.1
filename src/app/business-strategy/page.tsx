  ...
  useEffect(() => {
    async function loadDocuments() {
      try {
        ...
        const campaignDocs = allDocuments.filter(doc => 
          doc.category === '02_Campaign_Core' || doc.path.includes('02_Campaign_Core')
        );
        
        setDocumentGroups([
          {
            title: 'Foundation Documents',
            description: 'Core business positioning, brand guidelines, and foundational strategy documents.',
          ...
          },
          {
            ...
            description: 'Business model canvas, Porter\'s Five Forces, and market analysis frameworks.',
            icon: ChartBarIcon,
            color: 'blue',
          ...
          },
          {
            ...
            description: 'Implementation roadmaps, campaign concepts, and strategic execution plans.',
            icon: LightBulbIcon,
            color: 'green',
    ...
    <AppLayout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Business Strategy</h1>
            <p className="text-white/60">Strategic planning and business development resources</p>
          </div>
